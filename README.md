...
### 3. CGXAS_Exp_S Single-step Transfer learning
```shell
python ./Transfer_Exp.py
```

### 4. CGXAS_Exp_S Multi-step Transfer learning
```shell
python ./Transfer_Exp_cycle.py
```

### 5. Plot the Predicted Spectrum
